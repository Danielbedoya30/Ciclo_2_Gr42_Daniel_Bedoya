...
public class Persona_Class {
    ...
    public Persona_Class(String nombre, String tipo_documento, int numero_documento, char genero, String fecha_nacimiento, String municipio_nacimiento, String direccion, int telefono, String profesion, String estado_civil, boolean discapacidad, boolean estudia_actualmente, int cantidad_hijos) {
        this.nombre = nombre;
